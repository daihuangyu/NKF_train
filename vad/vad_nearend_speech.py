...
save_path = '/mnt/users/daihuangyu/AEC_Challenge/NKF_Data_From_AEC_Challenge/synthetic2/'
input_path = '/mnt/users/daihuangyu/AEC_Challenge/AEC-Challenge/datasets/synthetic/'
  
if not os.path.exists(save_path + '/nearend_speech_vad/'):
    os.makedirs(save_path + '/nearend_speech_vad/') 

    
for i in range(8517, 10000):
    wav = read_audio(input_path + 'nearend_speech/' + f'nearend_speech_fileid_{i}.wav', sampling_rate=16000)
