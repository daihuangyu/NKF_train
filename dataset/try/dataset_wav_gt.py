...
class MyDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        wav_start = np.random.randint(int(16000*0.5), int(16000*2))
        
        train_wav = train_wav[wav_start:wav_start+16000]
...
#         train_wav = normlization1d(train_wav)
#         speech_wav = normlization1d(speech_wav)
#         ref_wav = normlization1d(ref_wav)
...
def Mydata_loader(tp='train', batch_size=16, drop_last=False, num_workers=4):
